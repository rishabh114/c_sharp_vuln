...
CWE : CWE-916
Description : The MD5 hash (used by global::System.Security.Cryptography.MD5.Create) is insecure. Consider changing it to a secure hash algorithm.
*/
...
namespace dvcsharp_core_api.Models
{
   public class User
   {
      ...
      {
         var md5 = MD5.Create(); //Source and Sink
